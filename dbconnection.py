...
try:
  client = pymongo.MongoClient("mongodb+srv://anhnguyenbkcsna:admin@cluster0.xketide.mongodb.net/?retryWrites=true&w=majority")
...
# use a database named "test_db"
db = client.test_db

# use a collection named "user_db"
my_collection = db["user_db"]
